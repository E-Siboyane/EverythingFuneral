...
namespace EverythingFuneral.Web.Controllers {
    ...
    public class ManageController : Controller {
            ...
            try {
                if (ModelState.IsValid) {
                    ...
                    if (string.Compare(registerUser.ToLower(), true.ToString().ToLower(), true) == 0) {
                        ...
                        if (id >= 0) {
                            return RedirectToAction("Success", new { clientId = id });
                        }
                        else {
                            ViewBag.ValidationErrorMessage = "An error has occurred while trying to save the information, please try again.";
                            return View(funeralRequest);
        ...
        public bool UpdateRequest(RequestService requestService) {
            ...
            //var sendRequest = SendNewRequestEmail(requestService.RecordUniqueId);
            return (status);
        }

        public bool SendNewRequestEmail(Guid recordNumber) {
            // string mailBodyhtml = "<p>some text here</p>";
            // var msg = new MailMessage("e.siboyane@gmail.com", "e.siboyane@gmail.com", "Emai test", mailBodyhtml);
            //// msg.To.Add("to2@gmail.com");
            // msg.IsBodyHtml = true;
            // var smtpClient = new SmtpClient("smtp.gmail.com", 587); 
            // smtpClient.UseDefaultCredentials = true;
            // smtpClient.Credentials = new NetworkCredential("e.siboyane@gmail.com", "MESmtm3051!");
            // smtpClient.Timeout = 30000;
            // smtpClient.EnableSsl = true;
            // smtpClient.Send(msg);
            string your_id = "e.siboyane@gmail.com";
            string your_password = "MESmtm3051!";
            try {
                ...
                MailMessage mm = new MailMessage(your_id, "e.siboyane@gmail.com", "Elias", "Welcome to EF");
                client.Send(mm);
            }
            catch (Exception e) {
            }
